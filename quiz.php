...
// 3. The current user's session is started or continued in this code by session_start(). 
// The quiz's state, including the number of the current question, the user's responses, 
// and whether or not the quiz has been started, are stored in the session.
...
<body>
    ...
    <p style="color: gray">
        There is a certain relationship between two given words on one side of : : and one word is given on another side
        of : : while another word is to be found from the given alternatives, having the same relation with this word as
        the words of the given pair bear. Choose the correct alternative.
    </p>

    <h1>Question #
        <?php echo $question->getNumber(); ?>
    </h1>
    <h2 style="color: blue">
